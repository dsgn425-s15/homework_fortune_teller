class ZodiacsController < ApplicationController
  def sign
    zodiac = Zodiac.find_by({ :sign => params[:the_sign].downcase })
    renderZodiac(zodiac)
  end

  def creature
    zodiac = Zodiac.find_by({ :creature => params[:the_creature].downcase })
    renderZodiac(zodiac)
  end

  def renderZodiac zodiac
    if zodiac
      @sign = zodiac.sign.capitalize
      @prediction = zodiac.fortune
      @creature = zodiac.creature.capitalize
    else
      @sign = "Sign not found"
      @prediction =""
